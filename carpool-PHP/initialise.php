 ...
 */
  ...
  if(isset($_POST['host'])) {
    ...
    // create the database
    mysqli_query($con,"CREATE DATABASE $database") or die('Error creating database' . mysqli_error());
  ...
  PRIMARY KEY (`uid`)
  )") or die('Error creating table users;' . mysqli_error());
  ...
  `description` text,
  PRIMARY KEY (`id`))") or die('Error creating table "offers".' . mysqli_error());
  ...
  mysqli_query($con,"CREATE TABLE IF NOT EXISTS `notifications` (
    ...
    `cid` int(11) NOT NULL,
    PRIMARY KEY(`slno`))") or die('Error creating table "notifications".' . mysqli_error());
  ...
  mysqli_query($con,"CREATE TABLE IF NOT EXISTS `comments` (
    ...
    `cid` int(11) NOT NULL,
    PRIMARY KEY(`slno`))") or die('Error creating table "comments".' . mysqli_error());
  ...
  mysqli_query($con,"CREATE TABLE IF NOT EXISTS `route` (
    ...
    PRIMARY KEY (`routeid`)
    )") or die('Error creating table "route".' . mysqli_error());
